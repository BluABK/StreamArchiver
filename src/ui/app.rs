...
impl StreamArchiverApp {
    pub fn new(
        ...
        let settings = SettingsForm {
            ...
            auto_backfill_missed: setting_or_empty(&core, crate::downloader::vod::K_AUTO_BACKFILL_MISSED) == "1",
            ...
            chat_log_without_recording: setting_or_empty(&core, crate::downloader::K_CHAT_NO_RECORD)
                != "0",
            ...
            chat_index_enabled: crate::chat_scan::index_enabled(&core.store),
            chat_index_batch: crate::chat_scan::index_batch(&core.store).to_string(),
        ...
        let mut app = StreamArchiverApp {
            ...
            ad_popups: Vec::new(),
            ad_popup_registry: PopupRegistry::default(),
            meta_change_cache: HashMap::new(),
            meta_popups: Vec::new(),
            meta_popup_registry: PopupRegistry::default(),
            history_change_cache: HashMap::new(),
            history_popups: Vec::new(),
            history_popup_registry: PopupRegistry::default(),
            ...
            vod_info_popup_registry: PopupRegistry::default(),
            vod_info_popup_cache: HashMap::new(),
            trash_records: Vec::new(),
            users_query: String::new(),
            users_search_dirty: false,
            users_searched: false,
            users_results: Vec::new(),
            users_selected: None,
            users_detail: None,
            users_tab: crate::ui::users::UserTab::Streams,
            users_msg_filter: String::new(),
            users_text_query: String::new(),
            users_text_searched: false,
            users_text_hits: Vec::new(),
            ...
            users_scan_done: Arc::new(Mutex::new(None)),
            trash_loaded: false,
            trash_filter: String::new(),
            trash_show_soft_deleted: true,
            trash_show_permanent: true,
            trash_show_restored: true,
            ...
            remux_info_popup_registry: PopupRegistry::default(),
            remux_info_popup_cache: HashMap::new(),
            schedule_cache: HashMap::new(),
            schedule_popups: Vec::new(),
            schedule_popup_registry: PopupRegistry::default(),
            ...
            user_props_registry: Default::default(),
            ...
            stats_failures: None,
            stats_storage: None,
            stats_storage_drive: None,
            recordings_period: super::RecordingsPeriod::Day,
            stats_collabs: Vec::new(),
            stats_poll_span: super::PollSpan::Day,
            stats_history: None,
            stats_net_span: super::PollSpan::Day,
            stats_net_history: None,
            stats_net_daily: None,
            net_period: super::RecordingsPeriod::Day,
            stats_net_live: None,
    ...
    pub(super) fn save_settings(&mut self, ctx: &egui::Context) {
        ...
        let pairs = [
            ...
            (crate::downloader::vod::K_AUTO_BACKFILL_MISSED, if s.auto_backfill_missed { "1" } else { "0" }),
            ...
            (crate::downloader::K_CHAT_NO_RECORD, if s.chat_log_without_recording { "1" } else { "0" }),
            ...
            (crate::chat_scan::K_INDEX_ENABLED, if s.chat_index_enabled { "1" } else { "0" }),
            (crate::chat_scan::K_INDEX_BATCH, s.chat_index_batch.trim()),
